<section id="overlayAddStd" class="overlay">
    <div id="modelAddStd" class="container form-container">
        <form class="row justify-content-start bg-white form_content">
            ...
            <div class="d-flex justify-content-end">
                <button type="submit" id="btnSaveAdd" class="btn btn-primary d-flex w-auto form_btn mt-3">Lưu lại</button>
                <button type="button" id="btnCancelAddStd" class="btn btn-danger w-auto form_btn mt-3">Hủy</button>
            </div>
        </form>
    </div>
</section>
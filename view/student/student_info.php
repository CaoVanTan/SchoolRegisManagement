        ...
        <div class="row">
            <div class="col-12">
                <div class="ms-3 mb-3 row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" readonly value="<?php echo $row['std_name'] ?> " class="form-control" id="inputPassword" name="st_name">
                    </div>
                </div>
                <div class="ms-3 mb-3 row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" readonly value="<?php if ($row['std_gender'] == true) {
                                                                ...
                                                                echo 'Nữ';
                                                            } ?> " class="form-control" id="staticEmail" name="st_gender">
                    </div>
                </div>
                <div class="ms-3 mb-3 row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" readonly value="<?php $date = explode('-', $row['std_birthday']);
                                                            ...
                                                            echo  $birthday; ?> " class="form-control" id="inputPassword" name="st_date">
                    </div>
                </div>
                <div class="ms-3 mb-3 row">
                    <label for="staticEmail" class="col-sm-2 col-form-label">Số điện thoại: </label>
                    <div class="col-sm-8">
                        <input type="text" readonly value="<?php echo $row['std_phone'] ?> " class="form-control" id="staticEmail" name="st_phone">
                    </div>
                </div>
                <div class="ms-3 mb-3 row">
                    <label for="inputPassword" class="col-sm-2 col-form-label">Địa chỉ:</label>
                    <div class="col-sm-8">
                        <input type="text" readonly value="<?php echo $row['std_address'] ?> " class="form-control" id="inputPassword" name="st_address">
                    </div>
                </div>
                <div class="ms-3 mb-3 row">
                    <label for="staticEmail" class="col-sm-2 col-form-label">Email:</label>
                    <div class="col-sm-8">
                        <input type="text" readonly value="<?php echo $row['std_email'] ?> " class="form-control" id="staticEmail" name="st_email">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="ms-3 mb-3 row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" readonly value="<?php echo $row['std_id'] ?> " class="form-control" id="staticEmail" name="st_id">
                    </div>
                </div>
                <div class="ms-3 mb-3 row">
                    <label for="inputPassword" class="col-sm-2 ">Lớp học:</label>
                    <div class="col-sm-8">
                        <input type="text" readonly value="<?php echo $row['class_name'] ?> " class="form-control" id="inputPassword" name="st_name">
                    </div>
                </div>
                <div class="ms-3 mb-3 row">
                    <label for="staticEmail" class="col-sm-2 col-form-label">Khóa:</label>
                    <div class="col-sm-8">
                        <input type="text" readonly value="<?php echo $row['course_id'] ?> " class="form-control" id="staticEmail" name="st_gender">
                    </div>
                </div>
                <div class="ms-3 mb-3 row">
                    <label for="inputPassword" class="col-sm-2 col-form-label">Khoa:</label>
                    <div class="col-sm-8">
                        <input type="text" readonly value="<?php echo $row['office_name'] ?> " class="form-control" id="inputPassword" name="st_date">
                    </div>
                </div>
                <div class="ms-3 mb-3 row">
                    <label for="inputPassword" class="col-sm-2 col-form-label">Năm bắt đầu:</label>
                    <div class="col-sm-8">
                        <input type="text" readonly value="<?php echo $row['year_start'] ?> " class="form-control" id="inputPassword" name="st_date">
                    </div>
                </div>
            </div>
        </div>

<?php 
    ...
    include '../config/config.php';
     ...
     $sql = "SELECT s.std_id,s.std_name,s.std_gender,s.std_birthday,s.std_phone,s.std_email,s.std_address,s.std_pass,c.class_name,su.subject_name FROM student s, class c, subject su WHERE s.class_id=c.class_id and su.subject_id=s.subject_id";
